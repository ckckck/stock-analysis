...
- AI 筛选能力：本地 `screening.db` 保存股票基础资料、日线、快照、同步状态、筛选历史和结果快照；筛选查询由 AI 把自然语言转成只读 SQL，再执行并保存历史，见 `jcp/internal/services/screening_store.go:51`、`jcp/internal/services/screening_store.go:81`、`jcp/internal/services/screening_query_service.go:79`、`jcp/internal/services/screening_query_service.go:100`、`jcp/internal/services/screening_query_service.go:192`、`jcp/internal/services/screening_query_service.go:217`。
- AI 筛选同步能力：默认面向沪市和深市日线，支持首次 30/60/90/120 天手动同步、后续按最近交易日增量补齐、可选 30 天/60 天清理，以及仅在应用运行期间生效的定时同步，见 `jcp/internal/models/config.go:140`、`jcp/internal/services/screening_sync_service.go:67`、`jcp/internal/services/screening_sync_service.go:171`、`jcp/internal/services/screening_scheduler.go:19`、`jcp/internal/services/screening_scheduler.go:44`。
